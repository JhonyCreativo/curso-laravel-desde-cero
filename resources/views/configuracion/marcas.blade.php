                ...
                <div class="todo-app-menu">
                    ...
                    <div class="sidebar-menu-list">
                        ...
                        <div class="list-group">
                            ...
                            <a :href="url('marcas')" class="list-group-item border-0 active">
                                <span class="fonticon-wrap mr-50">
                                    <i class="ft-star"></i>
                                </span>
                                <span>Marcas</span>
                ...
                <div class="card shadow-none p-0 m-0">
                    <div class="card-header border-bottom py-75">
                        <div class="task-header d-flex justify-content-between align-items-center">
                            <h5 class="new-task-title mb-0">Nueva Marca</h5>
                        ...
                        <div class="card-content">
                            <div class="card-body py-0 border-bottom">
                                <div class="form-group">
                                   <input type="text" name="" class="form-control" placeholder="Nombre de Marca" id="" v-model="model.name">
                        ...
                        <div class="todo-app-list">
                            <div class="todo-fixed-search d-flex justify-content-between align-items-center">
                                ...
                                <fieldset class="form-group position-relative has-icon-left m-0 flex-grow-1 pl-2">
                                    <input type="text" class="form-control" v-model="buscar" placeholder="Buscar Marca...">
...
<script>
    ...
    createApp({
        ...
        methods:{
            ...
            async obtenerMarcas(){
                const respuesta = await axios.get("{{url('/')}}"+'/api/marcas');
                this.marcas = respuesta.data;
            },
            async GuardarMarca(){
                let respuesta = await axios.post("{{url('/')}}"+'/api/marcas',this.model);
            ...
            async ActualizarMarca(){
                let respuesta = await axios.put("{{url('/')}}"+'/api/marcas/'+this.model.id,this.model);
                await this.obtenerMarcas();
                this.model.name = '';
                this.showSidebar = false; 
            },
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                reverseButtons: true
                    ...
                    if (result.isConfirmed) {
                        let respuesta = await axios.delete("{{url('/')}}"+'/api/marcas/'+id);
                        await this.obtenerMarcas();
                        swalWithBootstrapButtons.fire({
                            title: "Eliminado!",

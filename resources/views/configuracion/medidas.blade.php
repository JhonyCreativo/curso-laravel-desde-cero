                ...
                <div class="todo-app-menu">
                    ...
                    <div class="sidebar-menu-list">
                        ...
                        <div class="list-group">
                            ...
                            <a :href="url('medidas')" class="list-group-item border-0 active">
                                <span class="fonticon-wrap mr-50">
                                    <i class="ft-star"></i>
                                </span>
                                <span>Medidas</span>
                ...
                <div class="card shadow-none p-0 m-0">
                    <div class="card-header border-bottom py-75">
                        <div class="task-header d-flex justify-content-between align-items-center">
                            <h5 class="new-task-title mb-0">Nueva Medida</h5>
                    ...
                    <div id="compose-form" class="mt-1">
                        <div class="card-content">
                            <div class="card-body py-0 border-bottom">
                                ...
                                <div class="form-group">
                                   <input type="text" name="" class="form-control" placeholder="Prefijo" id="" v-model="model.prefijo">
                                    ...
                                    <li v-for="(marca,index) in MarcaFiltros"  class="todo-item" data-name="David Smith">
                                        <div
                                            ...
                                            <div class="todo-title-area d-flex">
                                                ...
                                                <p @click="SeleccionarMarca(marca)" class="todo-title mx-50 m-0   truncate">{{marca.name}} | {{marca.prefijo}}</p>
                                            </div>
...
<script>
    ...
    createApp({
        ...
        computed:{
            MarcaFiltros(){
                if(this.buscar==""){
                    ...
                    return this.marcas.filter((medida)=>{
                        return medida.name.toLowerCase().indexOf(this.buscar.toLowerCase())>-1 || medida.prefijo.toLowerCase().indexOf(this.buscar.toLowerCase())>-1
                    })
                }
            }
        },
        ...
        methods:{
            ...
            async obtenerMarcas(){
                const respuesta = await axios.get("{{url('/')}}"+'/api/medidas');
                this.marcas = respuesta.data;
            },
            async GuardarMarca(){
                let respuesta = await axios.post("{{url('/')}}"+'/api/medidas',this.model);
            ...
            async ActualizarMarca(){
                let respuesta = await axios.put("{{url('/')}}"+'/api/medidas/'+this.model.id,this.model);
                await this.obtenerMarcas();
                this.model.name = '';
                this.model.prefijo = '';
                this.showSidebar = false; 
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                reverseButtons: true
                    ...
                    if (result.isConfirmed) {
                        let respuesta = await axios.delete("{{url('/')}}"+'/api/medidas/'+id);
                        await this.obtenerMarcas();
                        swalWithBootstrapButtons.fire({
                            title: "Eliminado!",
